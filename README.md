...
Please add an additional variables to local.properties file, provided by the developer within this [document](https://docs.google.com/document/d/16edRTkAF_O5cpSSH7izD5HNf9wVx4aYCxX4CKLImDmQ/edit?usp=sharing). Sync the project after variables added to the local.properties file.
Please request an access if you don't have permission to read the document.
This should prevent sensitive information pushed into the repository.

# Static Code Analysis Tool
Please install the Detekt plugin in Android Studio and [enable](https://github.com/detekt/detekt-intellij-plugin) the plugin.
Once enabled, please set the Detekt configuration file to this path {rootdir}/detekt/default-detekt-config.xml.
Tu ron the analysis tool, type "gradlew detekt" in the terminal.
